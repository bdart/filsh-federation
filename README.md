...
```
php composer.phar require --prefer-dist bdart/yii2-oauth2-server "*"
```

or add

```json
"bdart/yii2-oauth2-server": "~2.0"
```
...
```php
yii migrate --migrationPath=@vendor/bdart/yii2-oauth2-server/migrations
```
...
use bdart\yii2\oauth2server\filters\auth\CompositeAuth;
